...
public class TrafochainselectionPackageImpl extends EPackageImpl implements TrafochainselectionPackage {
	 ...
	 */
	@Override
	public EAttribute getTransformation_SrcMMCoverage() {
	 ...
	 */
	@Override
	public EAttribute getTransformation_TrgMMCoverage() {
	...
	public void createPackageContents() {
		...
		createEAttribute(transformationEClass, TRANSFORMATION__SRC_MM_COVERAGE);
		createEAttribute(transformationEClass, TRANSFORMATION__TRG_MM_COVERAGE);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getTransformation_SrcMMCoverage(), ecorePackage.getEDouble(), "srcMMCoverage", null, 0, 1, Transformation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTransformation_TrgMMCoverage(), ecorePackage.getEDouble(), "trgMMCoverage", null, 0, 1, Transformation.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
