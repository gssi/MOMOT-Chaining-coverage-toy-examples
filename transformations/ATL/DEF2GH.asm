...
<asm version="1.0" name="0">
	<cp>
		...
		<constant value="A.__matchD2G():V"/>
		<constant value="A.__matchE2H():V"/>
		<constant value="A.__matchF2H():V"/>
		<constant value="__exec__"/>
		<constant value="Root"/>
		<constant value="NTransientLinkSet;.getLinksByRule(S):QNTransientLink;"/>
		<constant value="A.__applyRoot(NTransientLink;):V"/>
		<constant value="D2G"/>
		<constant value="A.__applyD2G(NTransientLink;):V"/>
		<constant value="E2H"/>
		<constant value="A.__applyE2H(NTransientLink;):V"/>
		<constant value="F2H"/>
		<constant value="A.__applyF2H(NTransientLink;):V"/>
		...
		<constant value="link"/>
		<constant value="__matchD2G"/>
		<constant value="D"/>
		<constant value="G"/>
		<constant value="14:5-16:3"/>
		<constant value="__applyD2G"/>
		...
		<constant value="__matchE2H"/>
		<constant value="E"/>
		<constant value="H"/>
		<constant value="21:5-23:3"/>
		<constant value="__applyE2H"/>
		<constant value="h"/>
		...
		<constant value="__matchF2H"/>
		<constant value="F"/>
		<constant value="28:5-30:3"/>
		<constant value="__applyF2H"/>
		<constant value="f"/>
	...
	<operation name="91">
		...
		<localvariabletable>
			...
			<lve slot="1" name="86" begin="0" end="17"/>
		</localvariabletable>
	</operation>
	<operation name="101">
		<context type="6"/>
	...
	<operation name="115">
		...
		<linenumbertable>
			...
			<lne id="119" begin="12" end="13"/>
			<lne id="120" begin="11" end="14"/>
			<lne id="121" begin="9" end="16"/>
			<lne id="114" begin="8" end="17"/>
		</linenumbertable>
		<localvariabletable>
			<lve slot="3" name="62" begin="7" end="17"/>
			<lve slot="2" name="60" begin="3" end="17"/>
